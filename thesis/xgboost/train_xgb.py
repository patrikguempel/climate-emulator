...
# Parameter selection
params = {
    'objective': 'reg:squarederror',            #mse sed for regression
    'learning_rate': 0.01,
    'verbosity': 1,                             #logging
    'tree_method': 'hist',                      #algorithm for large datasets
...
def train():
    ...
    for max_depth in [10, 11, 12, 13, 14, 15]:
    ...
    for max_depth in range():
        params['max_depth'] = max_depth
        params['subsample'] = 0.8               #subsampling
