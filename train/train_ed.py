...
os.makedirs("models/ed", exist_ok=True)

callback_lr = LearningRateScheduler(schedule, verbose=1)  # use callback for lr scheduler

csv_logger = CSVLogger('models/ed/csv_logger.txt')  # define path where history of training is stored
