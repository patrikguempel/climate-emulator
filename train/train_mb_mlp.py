...
def createModel():
    ...
    layer_pre = layers.Dense(512, activation='relu')(input_layer)

    #branch_start = [layers.Dense(512, activation='relu')(layer_pre) for _ in range(10)]

    outputs = []
    for i in range(10):
        if i < 2:
            branch_start = layers.Dense(512, activation='relu')(layer_pre)
            ...
            branch_start = layers.Dense(128, activation='relu')(layer_pre)
