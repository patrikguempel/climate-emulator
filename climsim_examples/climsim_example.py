...
class MyHyperModel(HyperModel):
    ...
    def fit(self, hp, model, *args, **kwargs):
        ...
        self.tds = self.tds.prefetch(
            buffer_size=int(np.ceil(self.tds_shuffle_buffer / self.batch_size)))  # in realtion to the batch size
        ...
        self.tds_val = self.tds_val.prefetch(
            buffer_size=int(np.ceil(self.tds_shuffle_buffer / self.batch_size)))  # in realtion to the batch size
